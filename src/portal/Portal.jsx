...
function Thread({ zh }) {
  const { id } = useParams(); const navigate = useNavigate(); const { company, role } = useCompany(); const [body, setBody] = useState(''); const [busy, setBusy] = useState(false); const [error, setError] = useState(null);
